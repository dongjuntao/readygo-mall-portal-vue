<template>
  <div class="model-item" v-if="element">
    ...
    <!-- 好货推荐 -->
    <template v-if="element.type == 'goodsRecommend'">
    ...
    <!-- 优惠多多 -->
    <template v-if="element.type == 'manyDiscounts'">
      <many-discounts :data="element" class="mb_20 width_1200_auto"></many-discounts>
    </template>
  </div>
</template>
