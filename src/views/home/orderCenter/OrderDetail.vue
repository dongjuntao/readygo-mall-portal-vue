...
<!--    </div>-->
    ...
    <div class="order-card">
      ...
      <p>手机号码：{{order.recipientMobile | secrecyMobile}}</p>
      ...
      <table>
        ...
        <tbody>
          <tr v-for="(goods, goodsIndex) in order.orderDetailList" :key="goodsIndex">
            ...
            <td>
              <Button v-if="goods.afterSalesStatus == 'NOT_APPLIED' " @click="applyAfterSale(goods.sn)" type="info" size="small" class="mb_5">申请售后</Button>
